...
Choolaimedu = open("CHOOLAIMEDU.txt", "r").readlines()
anna_nagar = open("ANNA_NAGAR.txt","r").readlines()
mmda = open("MMDA.txt","r").readlines()
arumbakkam = open("ARUMBAKAM.txt","r").readlines()
custom = open("CUSTOM.txt","r").readlines()
kilpak = open("KILPAK.txt","r").readlines()
local = open("LOCAL.txt","r").readlines()
...
def view_store():
    ...
    book.save(r"/Records/"+str(file_name) + ".xlsx")
