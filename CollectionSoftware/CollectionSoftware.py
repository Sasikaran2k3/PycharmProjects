...
area_list = ["Full","Choolaimedu", "Anna Nagar", "MMDA"]
Choolaimedu = ["ARI ALAGAR STORES", "ARIHARAN STORES", "ARTHI FISH STORE", "ARTHI STORE(ARUM)"]
anna_nagar = ["ARUL HOTEL", "ARUL STORE (CHOO)", "ARUL SUPER STORE"]
mmda = ["RENGA STORE", "THIRUPATHI STORE", "PATHUBANATHAN STORE", "ISHWARYA SWEETS", "SELVA GANESH STORE", "KAVITHA STORE"]
...
area_count = {"Choolaimedu":0,"Anna Nagar":0,"Full":0,"MMDA":0}
completed = []
